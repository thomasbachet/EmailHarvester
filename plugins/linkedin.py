...
def search(domain, limit):
    ...
    yahooUrl = "https://search.yahoo.com/search?p=site%3Alinkedin.com+%40{word}&n=100&ei=UTF-8&va_vt=any&vo_vt=any&ve_vt=any&vp_vt=any&vd=all&vst=0&vf=all&vm=p&fl=0&fr=yfp-t-152&xargs=0&pstart=1&b={counter}"
    app_emailharvester.init_search(yahooUrl, domain, limit, 1, 100, 'Yahoo + Linkedin')
    app_emailharvester.process()
    all_emails += app_emailharvester.get_emails()
    
    bingUrl = "https://www.bing.com/search?q=site%3Alinkedin.com+%40{word}&count=50&first={counter}"
    ...
    url = 'https://www.baidu.com/s?wd=site%3Alinkedin.com+"%40{word}"&pn={counter}'
    app_emailharvester.init_search(url, domain, limit, 0, 10, 'Baidu + Linkedin')
    app_emailharvester.process()
    all_emails += app_emailharvester.get_emails()

    url = "https://www.exalead.com/search/web/results/?q=site%3Alinkedin.com+%40{word}&elements_per_page=10&start_index={counter}" 
